...
export const consonantDescriptions = {
  ...
  'θ': { features: 'Voiceless interdental fricative', example: 'thin', underlined: ['th'] },
  'ð': { features: 'Voiced interdental fricative', example: 'then', underlined: ['th'] },
...
export const vowelDescriptions = {
  ...
  'ej': { features: 'Mid front unrounded diphthong', example: 'bait', underlined: ['ai'] },
  'ow': { features: 'Mid-to-high back rounded diphthong', example: 'boat', underlined: ['oa'] },
  'aj': { features: 'Low central-to-front unrounded diphthong', example: 'my', underlined: ['y'] },
  'aw': { features: 'Low central unrounded diphthong', example: 'cow', underlined: ['ow'] },
  'ɔj': { features: 'Mid back-to-front, rounded-to-unrounded diphthong', example: 'boy', underlined: ['oy'] },
}
